  ...
  <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
    <div className="md:w-1/2 mb-8 md:mb-0">
      ...
      <p className="text-sm md:text-base">
        I'm probably not the typical dev stationed behind an IDE, but building tweaking fos and contemplating layouts is where you'll find me (~^~). I'm committed to creating fluent user experiences while staying fashionable.
      </p>
    </div>
