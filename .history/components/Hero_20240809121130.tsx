...
const Hero = () => {
  ...
  <div className="container bg-githubGray shadow-lg rounded-md mx-auto flex flex-col md:flex-row items-center md:px-8 overflow-hidden">
    ...
    <div className="relative flex-1 p-4 md:p-8">
      ...
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/rust/rust-original.svg"  className="w-8 h-8 md:w-16 md:h-16 lg:w-16 lg:h-16 bg-gptGray rounded-3xl shadow-deep-all animate-bounce absolute top-8 right-8" />
    ...
    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg" className="w-8 h-8 md:w-16 md:h-16 lg:w-16 lg:h-16 bg-gptGray rounded-3xl shadow-deep-all animate-bounce absolute bottom-8 right-4" />
  </div>
</section>
  );
};
