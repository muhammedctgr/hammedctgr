...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "This is an advanced map data across the the globe that shows infographic on specific",
  ...
  {
    title: "mydecors",
    description: "This fullstack eCommerce app where customers can order for interior design items",
