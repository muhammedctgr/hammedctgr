...
const projects: Project[] = [
  ...
  {
    title: "mydecors",
    description: "This is a fullstack eCommerce app where customers can search, check information and order for afforadb interior design items, which will be delivered to their doorsteps seamlessly",
