...
const SkillsSection: FC = () => {
  return (
    <section className="px-4 py-8 md:px-8 lg:px-12 bg-gptGray text-white">
  <div className="container bg-githubGray rounded-md mx-auto flex flex-col md:flex-row items-start">
    ...
    <div className="flex-1 flex flex-col items-center md:items-">
