...
const Footer = () => {
    return ( 
        <div className="bg-gptGray px-4 py-4 md:pt-8 md:px-8 lg:px-12">
            ...
            <p>
            <span className='font-size:100px;'>&#128187;</span> by <span className='bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text'>hammedctgr</span> for <a href="#" className='underline'>6ixville Inc.</a>
            </p>
            <div className="">
