...
const Hero = () => {
  ...
  <div className="container bg-githubGray shadow-lg rounded-md mx-auto flex flex-col md:flex-row items-center md:px-8">
    ...
    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg" className="w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 bg-gptGray rounded-3xl shadow-deep-all mt-4 animate-scroll-fast animate-scroll-delay" />
  </div>
</section>
  );
};
