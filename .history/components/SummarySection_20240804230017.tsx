  ...
  <div className="container bg-githubGray mx-auto flex flex-col md:flex-row justify-between items-start md:px-8 p-4 md:p-8">
    <div className=" mb-8 md:mb-8">
      ...
      <p className="text-sm md:text-base">
        I'm probably not the typical dev stationed behind a computer, but building state-of-the-art web apps, optimizing performance for scale and avoiding downtime is  you'll find me (~^~). I'm committed to creating fluent user experiences while staying fashionable.
      </p>
    </div>
