...
const Hero = () => {
  return (
    <section className="bg-gray-900 m-12 text-white min-h-screen flex items-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center m-12">
        <div className="flex-1 text-left md:text-left p-5 m-12">
          <div className="inline-block bg-blue-600 text-black py-1 px-3 mb-4 rounded-md">
            Hi, I’m
          </div>
          <div className="mb-10">
          <h1 className="text-4xl md:text-3xl font-bold">Popoola Muhammed</h1>
          <p className="mt-2 text-lg md:text-2xl">Full-Stack Developer, I build and manage</p>
          </div>
