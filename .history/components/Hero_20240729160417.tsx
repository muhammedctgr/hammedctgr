    ...
    <section className="bg-gray-900 text-white min-h-screen flex items-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="flex-1 text-center md:text-left p-5">
          <div className="inline-block bg-green-600 text-black py-1 px-3 mb-4 rounded-md">
            Hi, I’m
          </div>
          <h1 className="text-4xl md:text-6xl font-bold">Popoola Muhammed</h1>
          <p className="mt-2 text-lg md:text-xl">I am a Full-Stack Developer and I build and manage</p>
          <ul className="mt-4 list-disc list-inside">
            ...
            <li><span className="text-purple-400">IT</span> Development And Integration</li>
          </ul>
          <div className="mt-6">
