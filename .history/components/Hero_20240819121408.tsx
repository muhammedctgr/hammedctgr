    ...
    <div className="flex-1 text-left p-4 md:p-8">
      ...
      <div className="mt-6">
        ...
        <div className="mt-2 flex justify-start space-x-4">
          <a href="#" target="_blank" rel="noopener noreferrer" className="bg-blue-600 p-2 rounded-md shadow-deep-all transform transition-transform duration-300 hover:scale-110">
            <AiFillLinkedin size={20} />
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer" className="bg-githubGray p-2 rounded-md shadow-deep-all transform transition-transform duration-300 hover:scale-110">
