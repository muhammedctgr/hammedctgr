...
import profilePic from '../public/profile.jpg'; // Replace this with the actual path to your image
    ...
    <section className="bg-gray-900 text-white min-h-screen flex items-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="flex-1 text-center md:text-left p-5">
          ...
          <h1 className="text-4xl md:text-6xl font-bold">Marcus Ojo-Osasere</h1>
        ...
        <div className="flex-1 p-5">
          <div className="relative w-48 h-48 mx-auto md:w-72 md:h-72 lg:w-96 lg:h-96">
            <Image src={profilePic} alt="Marcus Ojo-Osasere" layout="fill" className="rounded-full object-cover" />
          </div>
        </div>
      </div>
    </section>
