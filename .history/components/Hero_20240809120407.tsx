...
const Hero = () => {
  ...
  <div className="container bg-githubGray shadow-lg rounded-md mx-auto flex flex-col md:flex-row items-center md:px-8 overflow-hidden">
    ...
    <div className="relative flex-1 p-4 md:p-8">
      ...
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg" className="w-8 h-8 md:w-16 md:h-12 lg:w-12 lg:h-12 bg-gptGray rounded-md animate-bounce shadow-deep-all" />
    </div>
