...
const Hero = () => {
  return (
    <section className="bg-gptGray px-4 py-4 md:px-8 lg:px-12 text-white min-h-screen flex items-center">
  <div className="container bg-githubGray rounded-md mx-auto flex flex-col md:flex-row items-center md:px-4">
