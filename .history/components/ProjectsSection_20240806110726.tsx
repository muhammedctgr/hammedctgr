...
const ProjectsSection: FC = () => {
  return (
    <section className="bg-gptGray py-16">
      <div className="container bg-githubGray rounded-md mx-auto px-4 md:px-8 lg:px-24">
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, i) => (
                    <span key={i} className="bg-gray-700 text-white text-xs px-2 py-1 rounded-md shadow-lg">{tech}</span>
                  ))}
                </div>
