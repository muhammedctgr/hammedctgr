...
const Hero = () => {
  return (
    <section className="bg-gray-900 m-12 mx-8 py-16 text-white min-h-screen flex items-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 p-5">
          <div className="relative w-48 h-48 mx-8 md:w-72 md:h-72 lg:w-96 lg:h-96">
