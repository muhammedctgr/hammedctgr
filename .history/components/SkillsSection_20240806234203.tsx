...
const SkillsSection: FC = () => {
  return (
  <section className="px-4 py-4 md:px-8 lg:px-12 bg-gptGray bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text">
