...
const Hero = () => {
  return (
    <section className="bg-gptGray px-4 py-8 md:px-8 lg:px-12 text-white min-h-screen flex items-center">
  <div className="container bg-white border border-gray-300 rounded-md mx-auto flex flex-col md:flex-row items-center p-6 shadow-lg">
