...
const SkillsSection: FC = () => {
  ...
  <div className="container bg-githubGray rounded-md mx-auto flex flex-col md:flex-row items-start md:px-8">
    ...
    <div className="flex-1 flex flex-col items-center md:items-end">
      ...
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgres/express-original.svg" className="w-8 h-8 md:w-12 md:h-12 lg:w-12 lg:h-12 bg-gptGray rounded-md animate-bounce shadow-deep-all mt-4" />
