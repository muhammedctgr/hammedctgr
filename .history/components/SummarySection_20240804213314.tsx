...
const SummarySection: FC = () => {
  return (
<section className="px-4 py-16 md:px-8 lg:px-12 bg-gray-900 relative overflow-hidden">
  <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
    <div className="md:w-1/2 mb-8 md:mb-0">
      ...
      <p className="text-sm md:text-base">
        I'm probably not the typical dev positioned behind an IDE, but I build. Immersed in stylesheets tweaking font sizes and contemplating layouts is where you'll find me (~^~). I'm committed to creating fluent user experiences while staying fashionable.
      </p>
    </div>
  ...
  <div className="absolute top-1/2 left-1/4 w-6 h-6 md:w-8 md:h-8 border-2 border-purple-800 rounded-full"></div>
