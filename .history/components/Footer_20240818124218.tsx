    ...
    return ( 
        <div className="bg-gptGray px-4 py-4 md:pt-4 md:px-4 lg:px-12">
            <div className='bg-gptGray px-4 py-4 md:pt-8 md:px-12 text-sm'>
                <p>
                <span className='text-2xl'>&#128187;</span> by <span className='bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text text-'>hammedctgr</span> under the license of <a href="https://6ixville.github.io/" target="_blank" rel="noopener noreferrer" className='underline'>6ixville Inc.</a>
                </p>
                <div className="">
