...
const Hero = () => {
  ...
  <div className="container bg-githubGray shadow-lg rounded-md mx-auto flex flex-col md:flex-row items-center md:px-8 overflow-hidden">
    ...
    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg" className="w-8 h-8 md:w-16 md:h-16 lg:w-16 lg:h-16 bg-gptGray rounded-3xl shadow-deep-all animate-bounce bottom-8" />
  </div>
</section>
  );
};
