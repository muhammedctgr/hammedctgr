...
const Hero = () => {
  ...
  <div className="container bg-githubGray shadow-lg rounded-md mx-auto flex flex-col md:flex-row items-center md:px-8 overflow-hidden">
    ...
    <div className="flex-1 p-4 md:p-8">
      ...
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/rust/rust-original.svg"  className="w-8 h-8 top-40 md:w-10 md:h-10 lg:w-10 lg:h-10 bg-gptGray rounded-3xl shadow-deep-all mt-4" />
