...
const Hero = () => {
  return (
    <section className="bg-gptGray px-4 py-8 md:px-16 lg:px-12 text-white min-h-screen flex items-center">
  <div className="container bg-githubGray rounded-md mx-auto flex flex-col md:flex-row items-center">
