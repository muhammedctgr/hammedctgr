...
<section className="px-4 py-4 md:px-8 lg:px-12 bg-gptGray relative overflow-hidden">
  ...
  <iframe loading="lazy" className="position: relative; width: 100%; height: 600px; max-height: 80vh; border: none; border-radius: 8px; padding: 0; margin: 0; overflow: hidden;"
      src="https://www.canva.com/design/DAGNY6sg1rQ/oXB11v4EPC8v5REGliKM_A/view?embed"  allow="fullscreen">
    </iframe>
