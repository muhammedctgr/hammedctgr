  ...
  return (
    <section className="bg-gptGray md:px-8 px-4 py-4">
      <div className="container bg-githubGray rounded-md mx-auto md:px-8 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap- p-4">
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, i) => (
                    <span key={i} className="bg-gray-700 text-white text-xs px-2 py-1 rounded-md shadow-2xl">{tech}</span>
                  ))}
                </div>
