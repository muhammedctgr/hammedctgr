...
const projects: Project[] = [
  {
    title: "Atease",
    description: "AutoSt is a store for those looking for their next car. The website features a dealership dashboard displaying inventories that can be done in minutes. Designed and developed by me.",
